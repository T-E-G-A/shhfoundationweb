        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="animate-fade-in">
              <Card hover={false}>
                <h2 className="text-2xl font-bold text-[#0F3F77] dark:text-white mb-6">Contact Information</h2>
                
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 dark:bg-[#1A2030] transition-all duration-300 hover:shadow-md">
                    <div className="w-10 h-10 flex-shrink-0 rounded-lg bg-gradient-to-br from-[#138A4B] to-[#1FA35C] flex items-center justify-center">
                      <FontAwesomeIcon icon={faEnvelope} className="text-white text-sm" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-sm mb-0.5 text-[#0F3F77] dark:text-white">Email</h3>
                      <a href="mailto:info@shhhfoundation.org" className="text-[#1E5AA6] dark:text-[#1FA35C] hover:underline text-xs">
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 dark:bg-[#1A2030] transition-all duration-300 hover:shadow-md">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm mb-0.5 text-[#0F3F77] dark:text-white">Phone / WhatsApp</h3>
                      <a href="tel:+2349037542055" className="text-[#1E5AA6] dark:text-[#1FA35C] hover:underline text-xs">
                        +234 903 754 2055
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 dark:bg-[#1A2030] transition-all duration-300 hover:shadow-md">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm mb-0.5 text-[#0F3F77] dark:text-white">Address</h3>
                ...
                <div className="border-t border-gray-200 dark:border-[#2A3447] pt-4 mb-6">
                  <h3 className="font-semibold text-sm mb-2 text-[#0F3F77] dark:text-white">Follow Us</h3>
                  <a
                    href="https://www.facebook.com/people/Syrilla-HealthCare-Helping-Hands-Foundation/61556988760462/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-[#1E5AA6] dark:text-[#1FA35C] hover:text-[#138A4B] dark:hover:text-[#1FA35C] text-sm transition-colors"
                  >
                ...
                <div className="border-t border-gray-200 dark:border-[#2A3447] pt-4">
            ...
            <div className="animate-fade-in animate-delay-100">
              <Card hover={false} className="h-full">
                <h2 className="text-2xl font-bold text-[#0F3F77] dark:text-white mb-4">Find Us</h2>
      ...
      <section className="py-16 md:py-20 bg-gray-50 dark:bg-[#131825]">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F3F77] dark:text-white mb-6 animate-fade-in">We Are Here for You</h2>
            <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-10 animate-fade-in animate-delay-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="text-center animate-fade-in">
                <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-br from-[#138A4B] to-[#1FA35C] flex items-center justify-center">
                  <FontAwesomeIcon icon={faHandHoldingHeart} className="text-white text-lg" />
                </div>
                <h3 className="font-bold text-[#138A4B] dark:text-[#1FA35C] mb-1 text-sm">Request Support</h3>
                <p className="text-gray-700 dark:text-gray-300 text-xs">
              ...
              <Card className="text-center animate-fade-in animate-delay-100">
                ...
                <h3 className="font-bold text-[#138A4B] dark:text-[#1FA35C] mb-1 text-sm">Volunteer</h3>
                <p className="text-gray-700 dark:text-gray-300 text-xs">
              ...
              <Card className="text-center animate-fade-in animate-delay-200">
                ...
                <h3 className="font-bold text-[#138A4B] dark:text-[#1FA35C] mb-1 text-sm">Donate</h3>
                <p className="text-gray-700 dark:text-gray-300 text-xs">
