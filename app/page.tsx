...
export default function Home() {
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative bg-gradient-to-br from-[#0F3F77] via-[#1E5AA6] to-[#0F3F77] dark:from-[#0A2D54] dark:via-[#0F3F77] dark:to-[#0A2D54] text-white py-24 md:py-32">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl animate-fade-in">
            ...
            <p className="text-lg md:text-xl mb-8 leading-relaxed text-gray-100 animate-fade-in animate-delay-100">
      ...
      {/* Mission Section */}
      <section className="py-16 md:py-20 bg-gray-50 dark:bg-[#0A0E1A]">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0F3F77] dark:text-white mb-6 animate-fade-in">
              Our Mission
            </h2>
      ...
      {/* Core Programs */}
      <section className="py-16 md:py-20 bg-white dark:bg-[#131825]">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-[#0F3F77] dark:text-white mb-12 animate-fade-in">
            Our Core Programs
          </h2>
