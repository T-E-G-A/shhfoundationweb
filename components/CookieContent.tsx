  ...
  return (
    <>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        ...
        <h3 className="font-bold">Performance and Analytics Cookies</h3>
        ...
        <h3 className="font-bold">Targeting and Advertising Cookies</h3>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">How Long Do Cookies Last</h2>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">Managing Your Cookie Preferences</h2>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">Do Not Track Signals</h2>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">Updates to This Cookie Policy</h2>
