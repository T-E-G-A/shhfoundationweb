export default function CookieContent() {
  return (
    <>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">3. How We Use Cookies</h2>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">4. Types of Cookies We Use</h2>
        <h3 className="font-bold">4.1 Essential Cookies</h3>
        ...
        <h3 className="font-bold">4.2 Performance and Analytics Cookies</h3>
        ...
        <h3 className="font-bold">4.3 Functional Cookies</h3>
        ...
        <h3 className="font-bold">4.4 Targeting and Advertising Cookies</h3>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">5. Third-Party Cookies</h2>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">6. How Long Do Cookies Last</h2>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">7. Managing Your Cookie Preferences</h2>
        ...
        <h3 className="font-bold">7.1 Browser Settings</h3>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">8. Do Not Track Signals</h2>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">9. Updates to This Cookie Policy</h2>
