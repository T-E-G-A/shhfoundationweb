export default function PrivacyContent() {
  return (
    <>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-8 mb-8">
        <h2 className="font-bold">International Data Transfers</h2>
